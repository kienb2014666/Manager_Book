<template>
  <div class="cart-order mt-2 bg-light p-4">
    <div class="row">
      <div class="col-2"></div>
      <div class="col-5">
        <h3>Mượn Sách</h3>
          ...
          >
            ...
            <div class="col-8">
              <div class="d-flex justify-content-between">
                <p>{{ product.name }}</p>
                <p>Giá: {{ product.price * product.amount }} VNĐ</p>
              </div>
      ...
      <div class="col-3">
        ...
        <p class="d-flex justify-content-between">
          <span>Tổng chi phí: </span> <span>{{ totalPrice }} VNĐ</span>
        </p>
        <p class="d-flex justify-content-between">
          <span>Phí vận chuyển: </span> <span>Free</span>
        </p>
        <hr />
