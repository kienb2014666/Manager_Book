<template>
  <div class="row mt-3">
    ...
    <div class="col-3">
      <h3>Tổng chi phí mượn sách</h3>
      <hr />
      <p class="d-flex justify-content-between">
        <span>Mức phí: </span> <span>{{ totalPrice }} VNĐ</span>
      </p>
      <p class="d-flex justify-content-between">
      ...
      <h5 class="d-flex justify-content-between">
        <span>Tổng: </span> <span>{{ totalPrice }} VNĐ</span>
      </h5>
      <hr />
        <div class="pb-4" >
          <div>
            <h6>Ngày mượn</h6>
            <p>Tính từ ngày bắt đầu thuê sách</p>
          </div>
          <div>
            <h6>Ngày trả(vui lòng điền ngày trả sách):</h6>
      ...
      <hr />
      <div class="my-3">
        <h5 class="form-label">Hình thức thanh toán</h5>
