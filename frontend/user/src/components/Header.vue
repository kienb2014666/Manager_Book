    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
      <div class="container-fluid">
        <router-link to="/" class="nav-header"
          ><p class="title">Manager Book</p></router-link
        >
        <div>
          <ul class="navbar-nav mb-2 mb-lg-0">
            <li class="nav-item">
              <router-link to="/type/Truyện Tranh" class="nav-header"
                ><p class="nav-link text-body">Truyện Tranh</p></router-link
              >
            </li>
            <li class="nav-item">
              <router-link to="/type/Tiểu Thuyết" class="nav-header"
                ><p class="nav-link text-body">Tiểu thuyết</p></router-link
              >
            </li>
            <li class="nav-item">
              <router-link to="/type/Sách Văn Học" class="nav-header"
                ><p class="nav-link text-body">Sách Văn Học</p></router-link
              >
            </li>
            <li class="nav-item">
              <router-link to="/type/Sách Lịch Sử" class="nav-header"
                ><p class="nav-link text-body">Sách Giáo Khoa</p></router-link
              >
            </li>
            <li class="nav-item">
              <router-link to="/type/Sách Giáo Khoa" class="nav-header"
                ><p class="nav-link text-body">Sách Lịch Sử</p></router-link
              >
            </li>
          </ul>
        </div>
